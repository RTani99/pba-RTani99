...
void WdWddW_Spring3(
  ...
  const Eigen::Matrix3d I = {1, 0, 0, 0, 1, 0, 0, 0, 1};
  ddw[0][0] = (length * I - n * length_ini) / length;
  ddw[1][1] = (length * I - n * length_ini) / length;
  ddw[0][1] = -(length * I - n * length_ini) / length;
  ddw[1][0] = -(length * I - n * length_ini) / length;
}
